...
// ✅ Get product recommendations (Apriori - frequently bought together)
...
// ✅ Get personalized recommendations for current user (Collaborative Filtering)
function getPersonalizedRecommendations(limit = 5) {
  return api.get(`/api/products/recommendations/for-me?limit=${limit}`);
}
